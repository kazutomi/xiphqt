...
{                                                                             \
   int i, j, k;                                                               \
                                                                              \
   for (k=0; k<f; k++) {                                                      \
      TYPE *frame = waveletbuf->data + offset +                               \
                        k * waveletbuf->width * waveletbuf->height;           \
                                                                              \
      for (j=0; j<h; j++) {                                                   \
         TYPE *row = frame + j * waveletbuf->width;                           \
                                                                              \
         for (i=0; i<w; i++) {                                                \
            TYPE coeff = row [i];                                             \
...
{                                                                             \
   int i, j, k;                                                               \
                                                                              \
   for (k=0; k<f; k++) {                                                      \
      TYPE *frame = waveletbuf->data + offset + k * width * height;           \
                                                                              \
      for (j=0; j<h; j++) {                                                   \
         TYPE *coeff = frame + j * width;                                     \
                                                                              \
         for (i=0; i<w; i++) {                                                \
            if (mask == 1 && coeff[i] == 0) {                                 \
